defmodule Absinthe.Type.BuiltIns.Scalars do
  ...
  def serialize_integer(n) do
    Logger.warn("Value #{inspect(n)} is not a valid integer. This will raise an error beginning in Absinthe v1.5.")
    Process.put(:absinthe_scalar_invalid, true)
    n
  end
  ...
  def serialize_float(n) do
    Logger.warn("Value #{inspect(n)} is not a valid float. This will raise an error beginning in Absinthe v1.5.")
    Process.put(:absinthe_scalar_invalid, true)
    n
  end
  ...
  def serialize_boolean(val) do
    Logger.warn("Value #{inspect(val)} is not a valid boolean. This will raise an error beginning in Absinthe v1.5.")
    Process.put(:absinthe_scalar_invalid, true)
    val
  end
